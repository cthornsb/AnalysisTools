...
int main(int argc, char* argv[]){
	...
	std::string method_names[6] = {"slope inversion stop (S vs. L)", "fixed height stop (S vs. L)", "fast fit guess (RMS) (S vs. L)",
								   "decay-side slope variation stop (S vs. L)", "fast fit guess (chi^2 vs. E)", "full root fitting (chi^2 vs. E)"};
